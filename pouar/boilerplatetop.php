...
echo '</head><body>';
echo '<div id=top><a href='.$root.'><img src='.$root.'marioskatehq2x.png style="position:absolute;top:0;left:0;"></a><div style="position:absolute;top:0px;right:150px;left:50px;"><ul id=links>';
